      ...
      <div style={{ position: 'fixed', top: 0, left: sidebarOpen ? 0 : '-300px', width: '270px', height: '100vh', background: '#09081a', borderRight: '1px solid #14122d', transition: 'all 0.3s ease', zIndex: 999, padding: '20px', boxSizing: 'border-box', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <button onClick={() => { setActiveTab('home'); setSidebarOpen(false); }} style={{ textAlign: 'left', width: '100%', padding: '12px 16px', background: activeTab === 'home' ? 'linear-gradient(90deg, #18153c, #0d0b24)' : 'none', border: 'none', borderRadius: '10px', color: activeTab === 'home' ? '#818cf8' : '#94a3b8', cursor: 'pointer', fontWeight: '600', fontSize: '14px' }}>📊 Statistics</button>
            <button onClick={() => { setActiveTab('manage'); setSidebarOpen(false); }} style={{ textAlign: 'left', width: '100%', padding: '12px 16px', background: activeTab === 'manage' ? 'linear-gradient(90deg, #18153c, #0d0b24)' : 'none', border: 'none', borderRadius: '10px', color: activeTab === 'manage' ? '#818cf8' : '#94a3b8', cursor: 'pointer', fontWeight: '600', fontSize: '14px' }}>📁 Files & Links</button>
            {isAdmin && <button onClick={() => { setActiveTab('admin'); setSidebarOpen(false); }} style={{ textAlign: 'left', width: '100%', padding: '12px 16px', background: activeTab === 'admin' ? 'linear-gradient(90deg, #18153c, #0d0b24)' : 'none', border: 'none', borderRadius: '10px', color: '#f59e0b', cursor: 'pointer', fontWeight: '600', fontSize: '14px' }}>⚙️ Admin Rules</button>}
          </div>
        </div>
        ...
        <div style={{ padding: '20px 14px', maxWidth: '600px', margin: '0 auto' }}>
          ...
          <div style={{ background: 'linear-gradient(135deg, #0e163a, #2e1035)', padding: '24px 20px', borderRadius: '20px', border: '1px solid #231942', boxShadow: '0 8px 20px rgba(0,0,0,0.3)', marginBottom: '20px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              ...
              <div>
                <label style={{ fontSize: '11px', color: '#94a3b8', fontWeight: '600' }}>Alias</label>
                <input type="text" placeholder="Alias (Optional)" style={{ width: '100%', padding: '12px 14px', background: '#050311', border: '1px solid #191438', borderRadius: '10px', color: '#fff', boxSizing: 'border-box', outline: 'none', marginTop: '4px', fontSize: '13px' }} value={alias} onChange={(e) => setAlias(e.target.value)} />
              </div>

              <div>
                <label style={{ fontSize: '11px', color: '#94a3b8', fontWeight
